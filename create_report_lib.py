...
class reportPDF(FPDF):
    ...
    def __init__(self,  title, author, author_info, date):
    ...
    def set_logo(self):
        self.logo = r"Bauhaus_Logo.png"  # Speichere den Pfad zu deinem Logo als Attribut   
    ...
    def cover(self):
        ...
        self.image(self.logo, x_pos, y_pos, new_width, new_height)
    ...
    def header(self):
        ...
        # Title
        self.cell(0, 20, self.title, border=1, align='C')
        # Date in the top right corner
        self.set_xy(-50, 8)
        #self.cell(0, 10, date, ln=False, align='R')
        self.cell(0, 10, self.date, new_x='right', new_y='top', align='R')
        # Author information in the bottom right corner
        self.set_xy(-50, 22)
        #self.cell(0, 10, author_info, ln=False, align='R')
        self.cell(0, 10, self.author_info, new_x='right', new_y='top', align='R')
        # Line break
        self.ln(15)
    ...
    def title_page(self):
        ...
        # Title
        self.cell(0, 10, self.title, new_x='right', new_y='top', align='C')
        self.ln(20)  # Add some vertical space
        # Set font for author and date
        self.set_font('helvetica', '', 12)
        # Author
        self.cell(0, 10, 'By ' + self.author, new_x='left', new_y='next', align='C')
        self.ln(20)  # Add some vertical space
        # Author information
        self.cell(0, 10, self.author_info, new_x='left', new_y='next', align='C')
        self.ln(20)  # Add some vertical space
        # Date
        self.cell(0, 10, 'Published on ' + self.date, new_x='right', new_y='next', align='C')
        self.ln(20)  # Add some vertical space
...
class presentationPDF(FPDF):
    ...
    def __init__(self, logo, title, author, author_info, date):
    ...
    def figure(self, image_path, caption):
        ...
        # Insert figure
        self.ln(8)
        #self.image(image_path, x=50, y=self.get_y() + 10, w=190)
        self.image(image_path, x=45, y=self.get_y() - 10, w=210)

        # Add caption
        self.set_font('helvetica', 'I', 12)
        self.cell(4, -10, ' ' + caption, new_x='right', new_y='next', align='L')
    ...
    def body_from_txt(self, file_path):
        ...
        #  Add body text with modified line spacing
        self.multi_cell(0, 12, text_content)  # Adjust the second parameter as needed
...
# presentation_pdf = presentationPDF(logo, title, author, author_info, date)
